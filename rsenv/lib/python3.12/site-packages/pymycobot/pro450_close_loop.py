...
class Pro450CloseLoop(DataProcessor):
    _write = write
    _read = read

    def __init__(self, debug=False):
        super(Pro450CloseLoop, self).__init__(debug)
    ...
    def _mesg(self, genre, *args, **kwargs):
        ...
        real_command, has_reply, _async = super(
            Pro450CloseLoop, self)._mesg(genre, *args, **kwargs)
        ...
        if self.__class__.__name__ == "Pro450Client":
            if genre == ProtocolCode.SET_FRESH_MODE:
                ...
                timeout = 5
                wait_time = 4
            elif genre == ProtocolCode.MERCURY_DRAG_TECH_PAUSE:
                wait_time = 6
                timeout = 6
